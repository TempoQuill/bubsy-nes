...
CHANNEL_SONG_ID:		.dsb 1 ; set
CHANNEL_SONG_CONFIGURATION:	.dsb 1 ; set
CHANNEL_SONG_BANK:		.dsb 1 ; set
CHANNEL_POINTER:		.dsb 2 ; set
CHANNEL_ENCODED_NOTE:		.dsb 1
CHANNEL_OCTAVE:			.dsb 1
CHANNEL_RAW_PITCH:		.dsb 2
CHANNEL_NOTE_LENGTH:		.dsb 1
CHANNEL_NOTE_LENGTH_MULTIPLIER:	.dsb 1 ; set
CHANNEL_TEMPO:			.dsb 1 ; set
CHANNEL_NOTE_DURATION:		.dsb 2 ; set
